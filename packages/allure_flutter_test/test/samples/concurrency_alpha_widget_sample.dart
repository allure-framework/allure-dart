...
///
/// Mirrors `packages/allure_dart_test/test/e2e/concurrency_samples/alpha_sample.dart`
...
/// explicitly (together with `concurrency_beta_widget_sample.dart`) by
/// `test/e2e/flutter_adapter_e2e_test.dart`.
library;
import 'package:allure_flutter_test/flutter_test.dart';

void main() {
  testWidgets('concurrency isolation widget sample alpha', (tester) async {
